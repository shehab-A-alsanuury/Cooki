...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['quizScore'] = isset($_SESSION['quizScore']) ? $_SESSION['quizScore'] + $score : $score;

    $message = "Your score for this attempt: $score. Total score updated to {$_SESSION['quizScore']}!";
}


$currentScore = isset($_SESSION['quizScore']) ? $_SESSION['quizScore'] : 0;
?>
...
<head>
    ...
    <title>Quiz with Sessions - Simplified</title>
</head>
<body>
<h1>Math Quiz</h1>
